👋 I [learn](https://nikiv.dev), [journal](https://nikiv.dev/looking-back), code [projects](https://nikiv.dev/focus) using [lovely tools](https://nikiv.dev/workflow) & track all [changes](https://nikiv.dev/changes).
